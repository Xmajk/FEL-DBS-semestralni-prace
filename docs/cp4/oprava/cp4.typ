...
#sql(
  ```sql
  INSERT INTO "ZaznamDochazky" ("cas_prichodu", "cas_odchodu", "typ_zaznamu", "id_zamestnanec")
  VALUES ('2062-04-02 10:00:00', NULL, 'Běžná pracovní doba', 1);

  INSERT INTO "ZaznamDochazky" ("cas_prichodu", "cas_odchodu", "typ_zaznamu", "id_zamestnanec")
    VALUES ('2062-04-03 10:00:00', NULL, 'Běžná pracovní doba', 1);
  ```,
)
...
#figure(
  caption: "Ukázka funkčnosti před vytvořením indexu",
  image("./other/index1.png"),
)

#figure(
  caption: "Ukázka funkčnosti po vytvoření indexu",
  image("./other/index2.png"),
)
